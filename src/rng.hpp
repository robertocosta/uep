...
template <class DegT>
fountain<DegT>::fountain(uint_fast32_t input_pkt_count) :
  K_(input_pkt_count),
  degree_distr(K_),
  packet_distr(0, K_-1),
  sel_count(0) {
...
template <class DegT>
typename fountain<DegT>::row_type fountain<DegT>::next_row() {
...
template <class DegT>
typename fountain<DegT>::row_type::size_type fountain<DegT>::generated_rows() const {
  return sel_count;
}

template <class DegT>
uint_fast32_t fountain<DegT>::K() const {
  return K_;
}

template <class DegT>
void fountain<DegT>::reset() {
  generator.seed();
  sel_count = 0;
}

template <class DegT>
void fountain<DegT>::reset(generator_type::result_type seed) {
  generator.seed(seed);
  sel_count = 0;
}
