...
%
L'overhead è definito, in riferimento ai parametri introdotti nella sezione (\ref{FCsection}),
 come $t =\frac{N-K}{K}$, cioè come l'aumento relativo del numero di pacchetti
