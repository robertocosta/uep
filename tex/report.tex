...
paragrafo~\ref{sec:modelli} è stato testato nei due casi di canale
senza memoria e di canale Markoviano.

\subsection{Canale senza memoria}
...
Sono stati usati gli stessi valori per i parametri del paper
\cite{uep} per permettere un confronto tra i risulati ottenuti in
questo progetto e i risultati di \cite{uep} e di verificare la
...
sotto-blocco e $RF_1 = 1$ il secondo, oltre a una ulteriore
ripetizione di $EF = 4$ volte del blocco così ottenuto. La lunghezza
del blocco virtuale è quindi pari a $EF \cdot \left( RF_0 \cdot K_0 +
RF_1 \cdot K_1 \right) = 4800$ pacchetti.
%
Il numero di pacchetti prodotti è fatto variare da 1000 a

\subsection{Canale Markoviano}
