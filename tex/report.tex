...
La finalità del progetto è estendere il paper \cite{uep} testando un algoritmo di trasmissione basato su UEP su un canale non privo di errori, per dimostrare che il protocollo di protezione non uniforme è utile ed efficiente in condizioni non error-free. 
\subsection{Diagramma} % Max 20 lines
...
Un altro tipo di canale markoviano testato è 
