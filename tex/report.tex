...
La finalità del progetto è estendere il paper \cite{uep} testando un algoritmo di trasmissione con protezione non uniforme su un canale non privo di errori, per dimostrare che il protocollo di protezione non uniforme è utile ed efficiente anche in condizioni non error-free.
