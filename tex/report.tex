...
10^{-4}, 10^{-2},10^{_1} \right\}$.

Trasmettendo un video H264 di 16000 frame sono state ottenute le
quattro curve mostrate in figura~\ref{plot:iid}.
%
\begin{figure}[htbp]
  \centering
...
\end{figure}
%
Le curve corrispondenti a $e=0$ sono coerenti con \cite{uep}, mentre è
possibile osservare che negli altri tre casi sono semplicemente
traslate a destra e mntengono la stessa forma.
